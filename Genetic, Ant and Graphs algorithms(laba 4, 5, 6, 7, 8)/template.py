...
from all_functions import USER_FUN
...
class EditableSpinbox(ttk.Spinbox):
    ...
    def __init__(self, frame, text, check_index, from_, to, increment, initial_value, name):
        ...
        self.label = Label(frame, text=text, background="#d1dbe0")
        self.warning_label = Label(frame, fg='black', textvariable=self.errmsg, wraplength=250, background="#d1dbe0")
...
class EditableCombobox(ttk.Combobox):
    ...
    def __init__(self, frame, text, name, background="#d1dbe0"):
