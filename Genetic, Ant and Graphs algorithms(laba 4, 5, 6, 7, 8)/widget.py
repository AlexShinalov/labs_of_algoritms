...
class EditableSpinbox(ttk.Spinbox):
    ...
    def __init__(self, frame, text, check_index, from_, to, increment, initial_value, name):
        ...
        self.label = Label(frame, text=text, background="gray")
        self.warning_label = Label(frame, fg='black', textvariable=self.errmsg, wraplength=250, background="gray")
...
class EditableCombobox(ttk.Combobox):
    ...
    def __init__(self, frame, text, name, background="gray"):
